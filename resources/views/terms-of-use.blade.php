                     ...
                     <div class="row d-flex align-items-center"> 
                        <div class="col-12 col-md-12">
                              <div class="dtr-styled-heading">
                                 <h2 class="orbitron-font color-blue">TERMS OF USE</h2>
                              </div>
                              <p class="dtr-mt-20">
                                 This website is operated by the <span class="color-blue">JOMA Manhire Family Trust trading as “Ondigicard”</span>. Throughout the site, the terms “we”, “us” and “our” refer to <a class="color-blue" href="https://www.ondigicard.com/">Ondigicard</a>. <a href="https://www.ondigicard.com/" class="color-blue">Ondigicard</a> offers this website, including all information, tools and services available from this site to you, the user, conditional upon your acceptance of all terms, conditions, policies and notices stated here.
                              </p>
                              <p class="dtr-mt-20">
                              ...
                              <div class="dtr-styled-heading dtr-mt-20 mb-0">
                                 <h4 class="orbitron-font font-weight-700 color-blue">ONLINE STORE TERMS</h4>
                              </div>
                              <p>
                              ...
                              <div class="dtr-styled-heading dtr-mt-20 mb-0">
                                 <h4 class="orbitron-font font-weight-700 color-blue">GENERAL CONDITIONS</h4>
                              </div>
                              <p>
                              ...
                              <div class="dtr-styled-heading dtr-mt-20 mb-0">
                                 <h4 class="orbitron-font font-weight-700 color-blue">ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h4>
                              </div>
                              <p>
                              ...
                              <div class="dtr-styled-heading dtr-mt-20 mb-0">
                                 <h4 class="orbitron-font font-weight-700 color-blue">MODIFICATIONS TO THE SERVICE AND PRICES</h4>
                              </div>
                              <p>
                                 Pricing of our products and/or services are subject to change without notice.
                              </p>
                              <p>
                              ...
                              <div class="dtr-styled-heading dtr-mt-20 mb-0">
                                 <h4 class="orbitron-font font-weight-700 color-blue">PRODUCTS OR SERVICES</h4>
                              </div>
                              <p>
                              ...
                              <div class="dtr-styled-heading dtr-mt-20 mb-0">
                                 <h4 class="orbitron-font font-weight-700 color-blue">ACCURACY OF BILLING AND ACCOUNT INFORMATION</h4>
                              </div>
                              <p>
                              ...
                              <div class="dtr-styled-heading mb-0">
                                 <h4 class="orbitron-font color-blue font-weight-700">OPTIONAL TOOLS</h4>
                              </div>
                              <p>
                              ...
                              <div class="dtr-styled-heading mb-0">
                                 <h4 class="orbitron-font color-blue font-weight-700">THIRD-PARTY LINKS</h4>
                              </div>
                              <p>
                              ...
                              <div class="dtr-styled-heading mb-0">
                                 <h4 class="orbitron-font color-blue font-weight-700">USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h4>
                              </div>
                              <p>
                              ...
                              <div class="dtr-styled-heading mb-0">
                                  <h4 class="orbitron-font color-blue font-weight-700">PERSONAL INFORMATION</h4>
                              </div>
                              <p>
                                 Your submission of personal information through the store is governed by our <a href="/privacy-policy" class="color-blue">Privacy Policy</a>.
                              </p>
                              <div class="dtr-styled-heading mb-0">
                                  <h4 class="orbitron-font color-blue font-weight-700">ERRORS, INACCURACIES AND OMISSIONS</h4>
                              </div>
                              <p>
                              ...
                              <div class="dtr-styled-heading mb-0">
                                  <h4 class="orbitron-font color-blue font-weight-700">PROHIBITED USES</h4>
                              </div>
                              <p>
                                 In addition to other prohibitions as set forth in the Terms of Use, you are prohibited from using the site or its content: <br>
                                 ...
                                 (g) to upload or transmit viruses or any other type of malicious code that will or may be used in any way that will affect the functionality or operation of the Service or of any related website, other websites, or the Internet; (h) to collect or track the personal information of others;<br>
                                 (i) to spam, phish, pharm, pretext, spider, crawl, or scrape; <br>
                                 (j) for any obscene or immoral purpose; or <br>
                                 (k) to interfere with or circumvent the security features of the Service or any related website, other websites, or the Internet. We reserve the right to terminate your use of the Service or any related website for violating any of the prohibited uses. All members understand that any publications, recordings or similar materials provided by <a href="https://www.ondigicard.com/" class="color-blue">Ondigicard</a> are intended for members only and must not be distributed to non-members.
                              </p>
                              <div class="dtr-styled-heading mb-0">
                                  <h4 class="orbitron-font color-blue font-weight-700">DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h4>
                              </div>
                              <p>
                              ...
                              <p>
                                 In no case shall <a href="https://www.ondigicard.com/" class="color-blue">Ondigicard</a>, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.
                              </p>
                              <div class="dtr-styled-heading mb-0">
                                  <h4 class="orbitron-font color-blue font-weight-700">INDEMNIFICATION</h4>
                              </div>
                              <p>
                                 You agree to indemnify, defend and hold harmless Ondigicard and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable solicitors/attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Use or the documents they incorporate by reference, or your violation of any law or the rights of a third party.
                              </p>
                              <div class="dtr-styled-heading mb-0">
                                  <h4 class="orbitron-font color-blue font-weight-700">SEVERABILITY</h4>
                              </div>
                              <p>
                              ...
                              <div class="dtr-styled-heading mb-0">
                                  <h4 class="orbitron-font color-blue font-weight-700">TERMINATION</h4>
                              </div>
                              <p>
                              ...
                              <div class="dtr-styled-heading mb-0">
                                  <h4 class="orbitron-font color-blue font-weight-700">ENTIRE AGREEMENT</h4>
                              </div>
                              <p>
                              ...
                              <div class="dtr-styled-heading mb-0">
                                  <h4 class="orbitron-font color-blue font-weight-700">GOVERNING LAW</h4>
                              </div>
                              <p>
                                 These Terms of Use and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of <span class="color-blue">Adelaide, South Australia</span>, Australia.
                              </p>
                              <div class="dtr-styled-heading mb-0">
                                  <h4 class="orbitron-font color-blue font-weight-700">CHANGES TO TERMS OF USE</h4>
                              </div>
                              <p>
                              ...
                              <div class="dtr-styled-heading mb-0">
                                  <h4 class="orbitron-font color-blue font-weight-700">CONTACT INFORMATION</h4>
                              </div>
                              <p>
                                 Questions about the Terms of Use should be sent to us at <a href="mailto:hello@ondigicard.com" class="color-blue">hello@ondigicard.com</a>.
                              </p>
                        </div>
                     </div>
                  </div>
